...
<body>
    <nav class="sidebar sticky h-screen flex flex-col px-[23px] items-center border-1">
        ...
        <div>
            <div x-data="{ open: false }" class="relative mb-[30px]">
                <a href="/">
                    <button
                        type="button"
                        class="flex items-center {{ request()->is('/') ? 'bg-yellow-500' : ''}} hover:bg-yellow-500 rounded-md px-[37px] py-[10px] min-w-full transition-all duration-300"
            ...
            <div x-data="{ open: {{ request()->is('inputBarang') || request()->is('outBarang') || request()->is('inventories') ? 'true' : 'false' }} }" class="mb-[30px]">
                ...
                <button
                    ...
                    type="button"
                    class="flex items-center hover:bg-yellow-500 rounded-md px-[37px] py-[10px] min-w-full transition-all duration-300"
                    style="height: 52px; font-size: 20px;">
                ...
                <div x-show="open"
                    ...
                    <div class="pt-[20px] flex flex-col gap-5 text-white">
                        <a href="/inputBarang" class="pl-[50px] {{ request()->is('inputBarang') ? 'text-yellow-500' : ''}} text-sm hover:text-yellow-500 transition-all duration-300">
                            Input Barang Masuk
                        </a>
                        <a href="/outBarang" class="pl-[50px] {{ request()->is('outBarang') ? 'text-yellow-500' : ''}} text-sm hover:text-yellow-500 transition-all duration-300">
                            Input Barang Keluar
                        </a>
                    </div>
                </div>
